...
<jet-authentication-card>
    ...
    <div class="card-body">
        ...
        <form @submit.prevent="submit">
            ...
            <select id="user_type" class="form-select" v-model="form.user_type_id">
                <option v-for="user_type in user_types" :key="user_type.id" :value="user_type.id">{{user_type.type}}</option>
            </select>
